...
namespace E_Commerce.Services
{
    public class ProductService : IProductService
    {
        ...
        public async Task<IEnumerable<BrandDTO>> GetAllBransdAsync()
        {
        ...
        public async Task<IEnumerable<TypeDTO>> GetAllTypesdAsync()
        {
        ...
        public async Task<Result<ProductDTO>> GetProductByIdAsync(int id)
        {
            ...
            return _mapper.Map<ProductDTO>(Product); // Implicit Casting To Resutl<ProductDTO>.Fail - Resutl<ProductDTO>.OK
        }
    }
}
